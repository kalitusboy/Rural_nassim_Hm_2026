      ...
      body: Column(
        children: [
          ...
          FutureBuilder<Map<String, dynamic>>(
            future: _dbService.getDashboardStats(),
            builder: (context, snap) {
              ...
              final withoutImg = d?['without_image'] as int? ?? 0;
              ...
              return Container(
                ...
                child: Column(children: [
                  Row(children: [
                    _DashTile(label: 'إجمالي',   value: total,      icon: Icons.people,          color: Colors.white),
                    _DashTile(label: 'محصاة',    value: done,       icon: Icons.check_circle,    color: Colors.greenAccent),
                    _DashTile(label: 'متبقية',   value: pending,    icon: Icons.pending,          color: Colors.amber),
                    _DashTile(label: 'بصورة',    value: withImg,    icon: Icons.camera_alt,       color: Colors.lightBlueAccent),
                    _DashTile(label: 'بلا صورة', value: withoutImg, icon: Icons.no_photography,  color: Colors.redAccent),
                  ]),
...
// لوحة الأرقام السريعة — بلاطة واحدة
